...
function LoginMFACopy () {
    ...
    const ValidateUserAndSendOTP = () => {
        axios.post('https://localhost:7253/validateandsendotp/user',details)
        .then((result)=>{
        ...
        <React.Fragment>
            ...
            <div className={loading ? "signup-main faded" : "signup-main"}>
                ...
                <div className="signup-section">
                    ...
                    (
                        <div>
                            {keyString !== "" ? <div>Please add this key in microsoft authenticator app {keyString} and then enter the OTP</div>:<div>Enter the OTP</div>}
